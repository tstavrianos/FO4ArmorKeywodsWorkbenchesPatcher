...
namespace FO4ArmorKeywodsWorkbenchesPatcher
{
    internal class Settings
    {
        ...
        [MaintainOrder]
        [SettingName("Move MISC (mods,junk,..) recipes to Advanced Engineering and Utility Workbench respectively")]
        [Tooltip(
            "The recipes for MISC items with components/materials attached to them are transferred to the Advanced Engineering Workbench while the rest goes to the Utility Workbench.")]
